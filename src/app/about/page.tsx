...
obisidian publishing은 월정액제입니다(반면 글로 얻는 수익은 $0입니다). 이러면 방안은 세 가지가 남게 됩니다: coda.io를 사용하거나, gitbook을 사용하거나, 직접 만들어야 하는 것이에요.  coda.io는 공개된 문서들만을 갈무리하여 관리하는 기능이 없었습니다. 반면 배포는 타 매체를 압도할 정도로 빠르고 간편합니다.
